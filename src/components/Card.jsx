      ...
      <div class="mt-4 px-5 pb-5">
        ...
        <div class="mt-2 mb-5 flex items-center justify-between">
          ...
          <div class="flex items-center" >
            <svg
              aria-hidden="true"
              className={`'h-5 w-5'${ratings >= 1 ? "text-yellow-300" : ""}`}
              fill="currentColor"
              viewBox="0 0 20 20"
            ...
            <svg
              aria-hidden="true"
              className={`'h-5 w-5'${ratings >= 2 ? "text-yellow-300" : ""}`}
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <svg
              aria-hidden="true"
              className={`'h-5 w-5'${ratings >= 3 ? "text-yellow-300" : ""}`}
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <svg
              aria-hidden="true"
              className={`'h-5 w-5'${ratings >= 4 ? "text-yellow-300" : ""}`}
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
            ...
            <svg
              aria-hidden="true"
              className={`'h-5 w-5'${ratings >= 5 ? "text-yellow-300" : ""}`}
              fill="currentColor"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <a onClick={cartHandler.bind(this, product)}
